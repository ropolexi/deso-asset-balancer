...
def get_user_balance(deso_exchange_rate,focus_exchange_rate):
    ...
    return usdc_coins,deso_balance_usd,focus_balance_usd
...
while True:
    ...
    usdc_coins,deso_balance_usd,focus_balance_usd = get_user_balance(deso_exchange_rate,focus_exchange_rate)
    print("*"*30)
    ...
    print("*"*30)
    total_balance = deso_balance_usd + usdc_coins + focus_balance_usd
    print(f"total_balance:${total_balance}")
    balance_per_asset = total_balance/3
    ...
    print(f"usd:${usdc_coins},deso:${deso_balance_usd},focus:${focus_balance_usd}")
